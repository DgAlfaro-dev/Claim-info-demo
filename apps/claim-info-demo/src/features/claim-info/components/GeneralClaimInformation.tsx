...
import { PROJECT_NAME, moneyFormat, Colones, Dollar, AlertBanner } from '@claim-info-demo/core';
...
import { useCountryConfigContext, FixedFieldId, getDefaultFieldConfig } from '@claim-info-demo/core';
